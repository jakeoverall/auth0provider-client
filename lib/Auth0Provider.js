...
class AuthPlugin extends EventEmitter {
  constructor(options = {}) {
    ...
    /** @type {createAuth0Client.Auth0Client} */
   ...
   * @param {createAuth0Client.PopupLoginOptions} o
  */
   ...
   * @param {createAuth0Client.RedirectLoginOptions} o
  */
  loginWithRedirect(o) {
    if (!o) {
      o = {
 ...
 * @param {createAuth0Client.GetTokenSilentlyOptions} [o]
 */
 ...
 * @param {createAuth0Client.GetTokenWithPopupOptions} o
 */
   ...
   * @param {createAuth0Client.LogoutOptions} o
  */
  logout(o) {
    o = o || { returnTo: window.location.origin }
